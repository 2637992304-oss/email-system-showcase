...
一个基于 Java 17、Spring Boot 与 Vue 3 构建的前后端分离邮件管理系统，覆盖用户认证、邮件管理、附件、搜索筛选、智能排序、实时通知、AI 翻译与摘要、垃圾邮件检测等场景。
...
围绕邮件正文提供中文翻译与内容摘要能力，帮助用户快速理解外文邮件并提取关键信息。
...
![邮件系统主页](assets/screenshots/mailbox-home.png)

### AI 翻译

![AI 翻译](assets/screenshots/ai-translation.png)

### AI 摘要

![AI 摘要](assets/screenshots/ai-summary.png)

### 垃圾邮件识别

![垃圾邮件识别](assets/screenshots/spam-detection.png)

## 项目资料

- [项目设计与功能说明](docs/project-overview.md)
- [我的个人贡献](docs/my-contribution.md)
- [功能界面截图](assets/screenshots)
...
本项目由团队共同完成。为保护团队成果和敏感配置，本展示仓库不提供完整源码，只展示经过整理的项目架构、功能说明、数据库设计、功能截图及个人贡献。面试时可进一步说明模块设计、接口流程和问题解决过程。
